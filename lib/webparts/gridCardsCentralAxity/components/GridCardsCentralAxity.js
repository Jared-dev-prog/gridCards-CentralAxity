...
var GridCardsCentralAxity = function (props) {
    ...
    return (React.createElement("div", { className: "".concat(styles.cards__container, " row") }, collectionData !== undefined
        ? collectionData.map(function (item, index) { return (React.createElement(Card, { key: index, text: item.text, background: item.typeBackground, withContent: item.withContent, link: item.link })); })
        : ""));
};
